...
-- DEPARTMENT 테이블을 복사한 DEPT_COPY2 새엉
...
-- DEPT_COPY2 테이블의 DEPT_ID, LOCATION_ID 컬럼만 이용해서
-- V_DCOPY2  VIEW 생성
...
INSERT INTO V_DCOPY2 VALUES('DO','L2');
...
SELECT * FROM TB_TEST; -- 125 -> 140으로 변경
...
SELECT * FROM TB_TEST; -- 130 -> 145으로 변경
...
/* INDEX(색인) -- 원하는 특정 데이터나 요소를 빨리 찾아갈 수 있게 하는것
